...
// returms 201 success
router.post('/update_user_settings', validator.checkSchema(schemas.userSettingsSchema), async (req, res) => {
...
// returms 201 success
router.post('/update_club_notifications', validator.checkSchema(schemas.notificationSchema), async (req, res) => {
